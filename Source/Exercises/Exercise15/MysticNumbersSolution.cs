...
namespace Exercises.Exercise15 {
    ...
    class MysticNumbersSolution {
        ...
        // 2 - finds the largest of the two given numbers
        ...
        // 3 - finds the largest of the four given numbers using TwoNumbers
        ...
        // 4 - finds the largest of the three given numbers using TwoNumbers
